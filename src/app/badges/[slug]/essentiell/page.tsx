...
const challenges = [
  { title: "Cross site scripting (XSS)", pdf: "/pdf/xss.pdf" },
  { title: "SQL Injection", pdf: "/pdf/SQLInjection.pdf" },
  { title: "MongoDB", pdf: "/pdf/Mongodb.pdf" },
  { title: "XML attacks", pdf: "/pdf/xml_attacks.pdf" },
  { title: "File Include Vulnerabilitie ", pdf: "/pdf/file_include.pdf" },
  { title: "Exploitation of SSTI", pdf: "/pdf/Server_Side_Template_injection.pdf" },
  { title: "Server-Side Request Forgery (SSRF)", pdf: "/pdf/Server_Side_Request_Forgery.pdf" },
  { title: "XMLDecoder", pdf: "/pdf/XMLDecoder.pdf" },
];
